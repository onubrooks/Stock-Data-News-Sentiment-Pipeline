...
perms:
	sudo mkdir -p logs plugins temp dags tests migrations data data/bronze data/silver data/gold data/gold/models visualization && sudo chmod -R u=rwx,g=rwx,o=rwx logs plugins temp dags tests migrations data data/bronze data/silver data/gold data/gold/models visualization
